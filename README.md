...
This app supports dynamic localisation using [i18next](https://www.i18next.com/) and [react-i18next](https://react.i18next.com/), with [i18next-browser-languagedetector](https://github.com/i18next/i18next-browser-languageDetector) to automatically detect the user's native OS language preferences and switch the app's language accordingly.

### Adding new text to localisations
...
If no key is specified in the localisation files, the app will simply display whatever text is passed into `i18n.t()`, to avoid errors.
...
The localisation is now ready to deploy and will appear to users who use your language for their browser.